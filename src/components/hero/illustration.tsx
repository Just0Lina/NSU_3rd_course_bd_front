        ...
        >
          <defs>
            ...
            <linearGradient x1="19.946%" y1="72.147%" x2="73.772%" y2="18.374%" id="browser-e">
              <stop stopColor="#F5ECE5" offset="0%" />
              <stop stopColor="#DBCBC0" offset="100%" />
            </linearGradient>
            <linearGradient x1="50%" y1="0%" x2="50%" y2="100%" id="browser-f">
              <stop stopColor="#DBCBC0" offset="0%" />
              <stop stopColor="#AD5D50" offset="100%" />
            </linearGradient>
            <linearGradient x1="50%" y1="0%" x2="50%" y2="100%" id="browser-g">
              <stop stopColor="#DBCBC0" offset="0%" />
              <stop stopColor="#F5ECE5" offset="100%" />
            </linearGradient>
            <linearGradient x1="94.808%" y1="-15.701%" x2="6.924%" y2="82.567%" id="browser-h">
              <stop stopColor="#DBCBC0" stopOpacity="0" offset="0%" />
